...
# Control vs. Initial Plots 5uM - 20C
```{r Control vs. Initial Plots - 5uM 20C}
#ammonium
...
```{r Control vs. Intial Plots - 5um 30C}
#ammonium
...
#######################################################################
#_____________________AMMONIUM_________________________________
### _______________Sym fed ammonium 5um 30C_______________________ ###
#first we need to melt the dataset
...
### ______________Sym starved ammonium 5um 30C________________________ ###
#first we need to melt the dataset
...
### ______________Apo fed ammonium 5um 30C________________________ ###
#first we need to melt the dataset
...
### ______________Apo starved ammonium 5um 30C________________________ ###
#first we need to melt the dataset
...
# Control vs. Initial Plots 30C - 1.5uM Nitrate
```{r Control vs. Initial Plots 30C - 1.5uM Nitrate}

#nitrate
sym_fed_nitrate_1.5um_30C<-subset(pam_all.data, pam_all.data$N_species=="N" & pam_all.data$sym_state=="S" & pam_all.data$food=="F" & pam_all.data$N_dose=="1.5" & pam_all.data$temp=="30")
apo_fed_nitrate_1.5um_30C<-subset(pam_all.data, pam_all.data$N_species=="N" & pam_all.data$sym_state=="A" & pam_all.data$food=="F" & pam_all.data$N_dose=="1.5" & pam_all.data$temp=="30")
sym_starved_nitrate_1.5um_30C<-subset(pam_all.data, pam_all.data$N_species=="N" & pam_all.data$sym_state=="S" & pam_all.data$food=="S" & pam_all.data$N_dose=="1.5" & pam_all.data$temp=="30")
apo_starved_nitrate_1.5um_30C<-subset(pam_all.data, pam_all.data$N_species=="N" & pam_all.data$sym_state=="A" & pam_all.data$food=="S" & pam_all.data$N_dose=="1.5" & pam_all.data$temp=="30")
...
### _______________Sym fed nitrate 1.5um 30C_______________________ ###
#first we need to melt the dataset
sym_fed_nitrate_1.5um_30C_melt<- melt(sym_fed_nitrate_1.5um_30C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_fed_nitrate_1.5um_30C$PAM_avg_day1,sym_fed_nitrate_1.5um_30C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_fed_nitrate_1.5um_30C<-
  ggplot(sym_fed_nitrate_1.5um_30C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot(width=0.8) +
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p= 0.513"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate 1.5um - Sym Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_nitrate_1.5um_30C


### ______________Sym starved nitrate 1.5um 30C________________________ ###
#first we need to melt the dataset
sym_starved_nitrate_1.5um_30C_melt<- melt(sym_starved_nitrate_1.5um_30C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_nitrate_1.5um_30C$PAM_avg_day1,sym_starved_nitrate_1.5um_30C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_nitrate_1.5um_30C<-
  ggplot(sym_starved_nitrate_1.5um_30C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.5, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.03169***"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate 1.5um - Sym Starved 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_nitrate_1.5um_30C

### ______________Apo fed nitrate 1.5um 30C________________________ ###
#first we need to melt the dataset
apo_fed_nitrate_1.5um_30C_melt<- melt(apo_fed_nitrate_1.5um_30C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_nitrate_1.5um_30C$PAM_avg_day1,apo_fed_nitrate_1.5um_30C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_nitrate_1.5um_30C<-
  ggplot(apo_fed_nitrate_1.5um_30C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.15, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test,p=0.02756*** "), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate 1.5um - Apo fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_apo_fed_nitrate_1.5um_30C


### ______________Apo starved nitrate 1.5um 30C________________________ ###
#first we need to melt the dataset
apo_starved_nitrate_1.5um_30C_melt<- melt(apo_starved_nitrate_1.5um_30C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_nitrate_1.5um_30C$PAM_avg_day1,apo_starved_nitrate_1.5um_30C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_nitrate_1.5um_30C<-
  ggplot(apo_starved_nitrate_1.5um_30C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.15, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.0004534***"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate 1.5um - Apo Starved 30C: Day 1 vs. Day 11 Fv/Fm")
gg_apo_starved_nitrate_1.5um_30C
```
# Control vs. Initial Plots 20C - 1.5uM Nitrate
```{r Control vs. Initial Plots 20C - 1.5uM}

#nitrate
sym_fed_nitrate_1.5um_20C<-subset(pam_all.data, pam_all.data$N_species=="N" & pam_all.data$sym_state=="S" & pam_all.data$food=="F" & pam_all.data$N_dose=="1.5" & pam_all.data$temp=="20")
apo_fed_nitrate_1.5um_20C<-subset(pam_all.data, pam_all.data$N_species=="N" & pam_all.data$sym_state=="A" & pam_all.data$food=="F" & pam_all.data$N_dose=="1.5" & pam_all.data$temp=="20")
sym_starved_nitrate_1.5um_20C<-subset(pam_all.data, pam_all.data$N_species=="N" & pam_all.data$sym_state=="S" & pam_all.data$food=="S" & pam_all.data$N_dose=="1.5" & pam_all.data$temp=="20")
apo_starved_nitrate_1.5um_20C<-subset(pam_all.data, pam_all.data$N_species=="N" & pam_all.data$sym_state=="A" & pam_all.data$food=="S" & pam_all.data$N_dose=="1.5" & pam_all.data$temp=="20")
...
### _______________Sym fed nitrate 1.5um 20C_______________________ ###
#first we need to melt the dataset
sym_fed_nitrate_1.5um_20C_melt<- melt(sym_fed_nitrate_1.5um_20C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_fed_nitrate_1.5um_20C$PAM_avg_day1,sym_fed_nitrate_1.5um_20C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_fed_nitrate_1.5um_20C<-
  ggplot(sym_fed_nitrate_1.5um_20C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot(width=0.8) +
  geom_jitter(width=0.5, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p= 0.1284"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate 1.5um - Sym Fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_nitrate_1.5um_20C


### ______________Sym starved nitrate 1.5um 20C________________________ ###
#first we need to melt the dataset
sym_starved_nitrate_1.5um_20C_melt<- melt(sym_starved_nitrate_1.5um_20C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_nitrate_1.5um_20C$PAM_avg_day1,sym_starved_nitrate_1.5um_20C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_nitrate_1.5um_20C<-
  ggplot(sym_starved_nitrate_1.5um_20C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.5, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.06049*"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate 1.5um - Sym Starved 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_nitrate_1.5um_20C

### ______________Apo fed nitrate 1.5um 20C________________________ ###
#first we need to melt the dataset
apo_fed_nitrate_1.5um_20C_melt<- melt(apo_fed_nitrate_1.5um_20C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_nitrate_1.5um_20C$PAM_avg_day1,apo_fed_nitrate_1.5um_20C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_nitrate_1.5um_20C<-
  ggplot(apo_fed_nitrate_1.5um_20C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.15, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test,p=0.6125 "), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate 1.5um - Apo fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_apo_fed_nitrate_1.5um_20C


### ______________Apo starved nitrate 1.5um 20C________________________ ###
#first we need to melt the dataset
apo_starved_nitrate_1.5um_20C_melt<- melt(apo_starved_nitrate_1.5um_20C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_nitrate_1.5um_20C$PAM_avg_day1,apo_starved_nitrate_1.5um_20C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_nitrate_1.5um_20C<-
  ggplot(apo_starved_nitrate_1.5um_20C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.15, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.05437***"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate 1.5um - Apo Starved 20C: Day 1 vs. Day 11 Fv/Fm")
gg_apo_starved_nitrate_1.5um_20C
```


# Control vs. Initial Plots 30C - 7.5uM ammonium
```{r Control vs. Initial Plots 30C - 7.5uM ammonium}

#ammonium
sym_fed_ammonium_7.5um_30C<-subset(pam_all.data, pam_all.data$N_species=="A" & pam_all.data$sym_state=="S" & pam_all.data$food=="F" & pam_all.data$N_dose=="7.5" & pam_all.data$temp=="30")
apo_fed_ammonium_7.5um_30C<-subset(pam_all.data, pam_all.data$N_species=="A" & pam_all.data$sym_state=="A" & pam_all.data$food=="F" & pam_all.data$N_dose=="7.5" & pam_all.data$temp=="30")
sym_starved_ammonium_7.5um_30C<-subset(pam_all.data, pam_all.data$N_species=="A" & pam_all.data$sym_state=="S" & pam_all.data$food=="S" & pam_all.data$N_dose=="7.5" & pam_all.data$temp=="30")
apo_starved_ammonium_7.5um_30C<-subset(pam_all.data, pam_all.data$N_species=="A" & pam_all.data$sym_state=="A" & pam_all.data$food=="S" & pam_all.data$N_dose=="7.5" & pam_all.data$temp=="30")
...
### _______________Sym fed ammonium 7.5um 30C_______________________ ###
#first we need to melt the dataset
sym_fed_ammonium_7.5um_30C_melt<- melt(sym_fed_ammonium_7.5um_30C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_fed_ammonium_7.5um_30C$PAM_avg_day1,sym_fed_ammonium_7.5um_30C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_fed_ammonium_7.5um_30C<-
  ggplot(sym_fed_ammonium_7.5um_30C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot(width=0.8) +
  geom_jitter(width=0.5, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p= 0.06272*"), vjust = 1, hjust = 1, size=3)+
  ggtitle("ammonium 7.5um - Sym Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_ammonium_7.5um_30C


### ______________Sym starved ammonium 7.5um 30C________________________ ###
#first we need to melt the dataset
sym_starved_ammonium_7.5um_30C_melt<- melt(sym_starved_ammonium_7.5um_30C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_ammonium_7.5um_30C$PAM_avg_day1,sym_starved_ammonium_7.5um_30C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_ammonium_7.5um_30C<-
  ggplot(sym_starved_ammonium_7.5um_30C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.5, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.1826"), vjust = 1, hjust = 1, size=3)+
  ggtitle("ammonium 7.5um - Sym Starved 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_ammonium_7.5um_30C

### ______________Apo fed ammonium 7.5um 30C________________________ ###
#first we need to melt the dataset
apo_fed_ammonium_7.5um_30C_melt<- melt(apo_fed_ammonium_7.5um_30C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_ammonium_7.5um_30C$PAM_avg_day1,apo_fed_ammonium_7.5um_30C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_ammonium_7.5um_30C<-
  ggplot(apo_fed_ammonium_7.5um_30C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.15, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test,p=0.5548 "), vjust = 1, hjust = 1, size=3)+
  ggtitle("ammonium 7.5um - Apo fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_apo_fed_ammonium_7.5um_30C


### ______________Apo starved ammonium 7.5um 30C________________________ ###
#first we need to melt the dataset
apo_starved_ammonium_7.5um_30C_melt<- melt(apo_starved_ammonium_7.5um_30C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_ammonium_7.5um_30C$PAM_avg_day1,apo_starved_ammonium_7.5um_30C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_ammonium_7.5um_30C<-
  ggplot(apo_starved_ammonium_7.5um_30C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.15, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.1254"), vjust = 1, hjust = 1, size=3)+
  ggtitle("ammonium 7.5um - Apo Starved 30C: Day 1 vs. Day 11 Fv/Fm")
gg_apo_starved_ammonium_7.5um_30C
```

# Control vs. Initial Plots 20C - 7.5uM
```{r Control vs. Initial Plots 20C - 7.5uM Ammonium}

#ammonium
sym_fed_ammonium_7.5um_20C<-subset(pam_all.data, pam_all.data$N_species=="A" & pam_all.data$sym_state=="S" & pam_all.data$food=="F" & pam_all.data$N_dose=="7.5" & pam_all.data$temp=="20")
apo_fed_ammonium_7.5um_20C<-subset(pam_all.data, pam_all.data$N_species=="A" & pam_all.data$sym_state=="A" & pam_all.data$food=="F" & pam_all.data$N_dose=="7.5" & pam_all.data$temp=="20")
sym_starved_ammonium_7.5um_20C<-subset(pam_all.data, pam_all.data$N_species=="A" & pam_all.data$sym_state=="S" & pam_all.data$food=="S" & pam_all.data$N_dose=="7.5" & pam_all.data$temp=="20")
apo_starved_ammonium_7.5um_20C<-subset(pam_all.data, pam_all.data$N_species=="A" & pam_all.data$sym_state=="A" & pam_all.data$food=="S" & pam_all.data$N_dose=="7.5" & pam_all.data$temp=="20")
...
### _______________Sym fed ammonium 7.5um 20C_______________________ ###
#first we need to melt the dataset
sym_fed_ammonium_7.5um_20C_melt<- melt(sym_fed_ammonium_7.5um_20C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_fed_ammonium_7.5um_20C$PAM_avg_day1,sym_fed_ammonium_7.5um_20C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_fed_ammonium_7.5um_20C<-
  ggplot(sym_fed_ammonium_7.5um_20C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot(width=0.8) +
  geom_jitter(width=0.5, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=  0.2634"), vjust = 1, hjust = 1, size=3)+
  ggtitle("ammonium 7.5um - Sym Fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_ammonium_7.5um_20C


### ______________Sym starved ammonium 7.5um 20C________________________ ###
#first we need to melt the dataset
sym_starved_ammonium_7.5um_20C_melt<- melt(sym_starved_ammonium_7.5um_20C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_ammonium_7.5um_20C$PAM_avg_day1,sym_starved_ammonium_7.5um_20C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_ammonium_7.5um_20C<-
  ggplot(sym_starved_ammonium_7.5um_20C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.5, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.003379***"), vjust = 1, hjust = 1, size=3)+
  ggtitle("ammonium 7.5um - Sym Starved 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_ammonium_7.5um_20C

### ______________Apo fed ammonium 7.5um 20C________________________ ###
#first we need to melt the dataset
apo_fed_ammonium_7.5um_20C_melt<- melt(apo_fed_ammonium_7.5um_20C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_ammonium_7.5um_20C$PAM_avg_day1,apo_fed_ammonium_7.5um_20C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_ammonium_7.5um_20C<-
  ggplot(apo_fed_ammonium_7.5um_20C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.15, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test,p=0.6846"), vjust = 1, hjust = 1, size=3)+
  ggtitle("ammonium 7.5um - Apo fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_apo_fed_ammonium_7.5um_20C


### ______________Apo starved ammonium 7.5um 20C________________________ ###
#first we need to melt the dataset
apo_starved_ammonium_7.5um_20C_melt<- melt(apo_starved_ammonium_7.5um_20C, id.vars="exp_1_beetag", measure.vars=c("PAM_avg_day1","PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_ammonium_7.5um_20C$PAM_avg_day1,apo_starved_ammonium_7.5um_20C$PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_ammonium_7.5um_20C<-
  ggplot(apo_starved_ammonium_7.5um_20C_melt, aes(x=variable, y=value, color=variable)) +
  geom_boxplot() +
  geom_jitter(width=0.15, alpha=0.9) +
  geom_line(aes(group=exp_1_beetag), col="darkgray")+
  ylab("Fv/Fm value")+
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.5141"), vjust = 1, hjust = 1, size=3)+
  ggtitle("ammonium 7.5um - Apo Starved 20C: Day 1 vs. Day 11 Fv/Fm")
gg_apo_starved_ammonium_7.5um_20C
```

```{r Comparing delta PAM for datasets that where control sigificantly changed}
#Sym fed
t.test(sym_fed_control_20C$PAM_delta, sym_fed_ammonium_5um_20C$PAM_delta, paired=FALSE) 
#p = 0.9777, the difference in PAM from day 1 to 11 is NOT significantly different for control vs. A 5uM 
#Sym Starved
t.test(sym_starved_control_20C$PAM_delta, sym_starved_nitrate_1.5um_20C$PAM_delta)
#p = 0.8655, the difference in PAM from day 1 to 11 is NOT significantly different for control vs. N 1.5uM
t.test(sym_starved_control_20C$PAM_delta, sym_starved_nitrate_5um_20C$PAM_delta)
#p = 0.7976, the difference in PAM from day 1 to 11 is NOT significantly different for control vs. N 5uM
t.test(sym_starved_control_20C$PAM_delta, sym_starved_ammonium_high_20C$PAM_delta)
#p = 0.5778, the difference in PAM from day 1 to 11 is NOT significantly different for control vs. A 10uM
t.test(sym_starved_control_20C$PAM_delta, sym_starved_ammonium_5um_20C$PAM_delta)
#p = 0.5423, the difference in PAM from day 1 to 11 is NOT significantly different for control vs. A 5uM
t.test(sym_starved_control_20C$PAM_delta, sym_starved_ammonium_7.5um_20C$PAM_delta)
#p = 0.2288, the difference in PAM from day 1 to 11 is NOT significantly different for control vs. A 7.5uM

#playing around with some other t tests
t.test(sym_starved_ammonium_high_20C$PAM_delta, sym_starved_ammonium_7.5um_20C$PAM_delta)
```
