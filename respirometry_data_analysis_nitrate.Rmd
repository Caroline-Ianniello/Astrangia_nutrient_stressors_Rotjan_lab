...
ggplot(data = SICB_data_nitrate_1 ,
  ...
  labs(x = "Nitrate dose", 
    ...
    scale_x_discrete("Nitrate dose", labels=c(CNTRL_0="0uM", N_1.5="1.5uM", N_5="5uM", N_18="18uM"))

nitrate_SICB_model_1 <- lmer(LOG_abs_resp_rate_SA_corr ~ N_species_dose + red_day11 +  N_species_dose*red_day11 + (1 | col_num)  + (1 | jar_unique_ID), data= SICB_data_nitrate_1)
...
SICB_data_nitrate_noEC <- resp_all_nitrate.data %>%
 ...
 filter(abs_resp_rate_SA_corr<0.7) %>% #there is one 7.5 at 20C thats really high and looks like an outlier to me
  filter(beetag_exprun!= "G33Y97_exp2A") #this was at E coli at 30C, and it was at like 0.23 and also looked like an outlier
nitrate_SICB_model_noEC <- lmer(LOG_abs_resp_rate_SA_corr ~ control_or_nutrient + temp + red_day11 +  control_or_nutrient*temp + control_or_nutrient*red_day11 + temp*red_day11 + control_or_nutrient*red_day11*temp  + control_or_nutrient*red_day11*temp + (1 | col_num)  + (1 | jar_unique_ID), data= SICB_data_nitrate_noEC)
