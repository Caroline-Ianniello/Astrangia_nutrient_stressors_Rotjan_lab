...
full.model <- lmer(resp_rate ~  N_species_dose + temp + food + sym_state + e_coli_plate + N_species_dose*temp + N_species_dose*food + N_species_dose*sym_state + N_species_dose*e_coli_plate + temp*food + temp*sym_state + temp*e_coli_plate + food*sym_state + food*e_coli_plate + sym_state*e_coli_plate +  (1|col_num) + (1|exp_num) , data= nitrate_without_control)
print(step.model<- step(full.model))


mm_without_controls <-lmer(resp_rate ~ N_species_dose + sym_state + e_coli_plate + temp + (1 | col_num), data=nitrate_without_control)
...
full.model <- lmer(resp_rate ~  N_species_dose + temp + food + sym_state + e_coli_plate + N_species_dose*temp + N_species_dose*food + N_species_dose*sym_state + N_species_dose*e_coli_plate + temp*food + temp*sym_state + temp*e_coli_plate + food*sym_state + food*e_coli_plate + sym_state*e_coli_plate +  (1|col_num) + (1|exp_num) , data= nitrate_controls)
print(step.model<- step(full.model))


mm_controls <-lmer(resp_rate ~ sym_state + e_coli_plate + temp + (1 | col_num), data=nitrate_controls)
...
full.model_fed_nitrate <- lmer(resp_rate ~  N_species_dose + temp + sym_state + e_coli_plate + N_species_dose*temp +  N_species_dose*sym_state + N_species_dose*e_coli_plate + temp*sym_state + temp*e_coli_plate +  sym_state*e_coli_plate +  (1|col_num) + (1|exp_num) , data= all_fed_nitrate)
print(step.model<- step(full.model_fed_nitrate))

mm_fed_nitrate <- lmer(resp_rate ~  N_species_dose + temp + sym_state + e_coli_plate +  (1|col_num) , data= all_fed_nitrate)
...
full.model_starved_nitrate <- lmer(resp_rate ~  N_species_dose + temp + sym_state + e_coli_plate + N_species_dose*temp +  N_species_dose*sym_state + N_species_dose*e_coli_plate + temp*sym_state + temp*e_coli_plate +  sym_state*e_coli_plate +  (1|col_num) + (1|exp_num) , data= all_fed_nitrate)
print(step.model<- step(full.model_starved_nitrate))

mm_starved_nitrate <- lmer(resp_rate ~ N_species_dose + temp + sym_state + e_coli_plate +  (1|col_num) , data= all_starved_nitrate)
