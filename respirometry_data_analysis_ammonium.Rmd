...
ggplot(data = SICB_data_ammonium_1 ,
       aes(x = N_species_dose,
           y = abs_resp_rate_SA_corr, color=N_species_dose)) +
    geom_boxplot() +
  ...
  labs(x = "ammonium dose", 
    ...
    scale_x_discrete("Ammonium dose", labels=c(CNTRL_0="0uM", A_5="5uM", A_7.5="7.5uM", A_10="10uM"))
...
ammonium_SICB_model_noEC <- lmer(LOG_abs_resp_rate_SA_corr ~ control_or_nutrient + temp + red_day11 +  control_or_nutrient*temp + control_or_nutrient*red_day11 + temp*red_day11 + control_or_nutrient*red_day11*temp  + control_or_nutrient*red_day11*temp + (1 | col_num)  + (1 | jar_unique_ID), data= SICB_data_ammonium_noEC)
...
#nothing sig
(summary(emmeans(ammonium_SICB_model_noEC, specs=pairwise ~ temp)))
...
ggplot(data = SICB_data_ammonium_noEC ,
       aes(x = control_or_nutrient,
           y = abs_resp_rate_SA_corr, color=temp)) +
    geom_boxplot() +
     geom_point(position=position_jitterdodge())+
  ggtitle("Ammonium") +
  ylim(0, 0.2) +
...
(summary(emmeans(ammonium_SICB_model_RGB_noEC, specs=pairwise ~ control_or_nutrient))) 

library(ggplot2)
ggplot(data = SICB_data_ammonium,
       aes(x = control_or_nutrient,
           y = red_day11, color=temp)) +
    geom_point() +
  geom_abline()
...
ggplot(data = SICB_data_ammonium ,
    ...
    geom_boxplot(outlier.shape = NA) +
     geom_point(position=position_jitterdodge(), size=2)+
  ggtitle("Ammonium RGB") +
  labs(x = "ammonium dose", 
         y = expression(paste("Red Channel Value")), 
         caption = " " ) +
    scale_x_discrete("", labels=c(Control="No Ammonium", ammonium="Ammonium")) +
    scale_color_manual("Temperature", labels=c("20°C", "30°C"),values=c("blue", "darkred")) 
