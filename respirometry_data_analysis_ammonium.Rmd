...
mm_resp_2 <- lm(resp_rate ~ N_species_dose + e_coli_plate + sym_state, data=resp_all_ammonium.data)
summary(mm_resp_2)
...
mm_resp_control_or_nutrient <- lmer(resp_rate ~ control_or_nutrient + e_coli_plate + sym_state + temp + (1|vial_ID) + (1 | col_num), data=resp_all_ammonium.data)
...
# STATS STATS STATS
mm_resp_control_v_nutrient <- lmer(resp_rate ~  e_coli_plate + control_or_nutrient + (1 | col_num), data=resp_all_ammonium.data)
