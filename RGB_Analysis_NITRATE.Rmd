...
mm_rgb_1 <- lmer(red_delta ~ N_species_dose + sym_state + N_species_dose*sym_state +(1|col_num) + (1|exp_num) , data= rgb_all_nitrate.data)
summary(mm_rgb_1)
...
summary(aov( red_delta ~ sym_state, data=rgb_all_nitrate.data))
...
gg_rgb_treatmeans_temp_sym<-ggplot(data = rgb_treatmeans_temp_sym,
    ...
    geom_errorbar(aes(ymin=red_delta-se, ymax=red_delta+se), width=0.1, size = 1) +
    #scale_color_manual(values = c("black", "darkgreen")) +
    ggtitle ("Nitrate rgb Delta sym state Temperature summary") +
  theme(legend.position="none")+
    labs(x = "Temperature", 
         y = expression(paste("Day 11 Photosynthetic Efficiency Red channel value")), 
         caption = "data represent mean +/- SEM" ) +
...
gg_rgb_treatmeans_temp_sym<-ggplot(data = rgb_treatmeans_temp_sym,
    ...
    geom_errorbar(aes(ymin=red_delta-se, ymax=red_delta+se), width=0.1, size = 1) +
    #scale_color_manual(values = c("black", "darkgreen")) +
    ggtitle ("No controls Nitrate rgb Delta sym state Temperature summary") +
  theme(legend.position="none")+
    labs(x = "Temperature", 
         y = expression(paste("Day 11 Photosynthetic Efficiency Red channel value")), 
         caption = "data represent mean +/- SEM" ) +
...
gg_N_species_dose_temp_nitrate<-ggplot(data = sum_N_species_dose_temp_nitrate,
    ...
    geom_errorbar(aes(ymin=red_delta-se, ymax=red_delta+se), width=0.1, size = 1) +
    #scale_color_manual(values = c("black", "darkgreen")) +
    ggtitle ("Nitrate rgb Delta Dose and Temperature summary") +
    labs(x = "Nitrate dose", 
         y = expression(paste("Day 11 Photosynthetic Efficiency Red channel value")), 
         caption = "data represent mean +/- SEM" ) +
    scale_x_discrete("Nitrate dose", labels=c(CNTRL_0="Control", N_1.5="1.5uM", N_5="5uM", N_18="18uM"))+
