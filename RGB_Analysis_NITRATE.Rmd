...
fullModel = lm(red_delta ~   N_species_dose + temp + sym_state  + N_species_dose*temp + N_species_dose*sym_state + temp*sym_state, data= rgb_all_nitrate.data) # model with all 9 variables and possible combinations
...
lm_rgb_2 <- lm(formula = red_delta ~ sym_state + temp + N_species_dose, data = rgb_all_nitrate.data)
summary(lm_rgb_2)
lm_rgb_3 <- lm(formula = red_delta ~ sym_state + temp , data = rgb_all_nitrate.data)
summary(lm_rgb_3)
#WINNER OUT OF ALL COMBINATIONS
lm_rgb_4 <- lm(formula = red_delta ~ sym_state + N_species_dose, data = rgb_all_nitrate.data)
summary(lm_rgb_4)
...
#linear model 3 is the winner here
