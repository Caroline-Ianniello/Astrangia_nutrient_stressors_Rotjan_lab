...
#subset just apo from PAM_day1_11_summary
PAM_day1_11_summary_APO <- PAM_day1_11_summary %>% 
filter(sym_state=="APO")

gg_apo_PAM <- ggplot(data = PAM_day1_11_summary_APO,
                           aes(x = day_NO3,
                               y = PAM_avg, col = temp, shape = sym_state, group = interaction(temp, NO3_category))) +  # Group by sym_state, temp, and NO3_category
...
#subset just sym from PAM_day1_11_summary
PAM_day1_11_summary_sym <- PAM_day1_11_summary %>% 
filter(sym_state=="SYM")

gg_sym_PAM <- ggplot(data = PAM_day1_11_summary_sym,
                           aes(x = day_NO3,
                               y = PAM_avg, col = temp, shape = sym_state, group = interaction(temp, NO3_category))) +  # Group by sym_state, temp, and NO3_category
...
gg_PAM_apo_sym <- gg_apo_PAM / plot_spacer() / gg_sym_PAM  +  # Add plot_spacer() between the plots
...
# Save the plot
ggsave(file="Figures/gg_PAM_apo_sym.svg", plot=gg_PAM_apo_sym, device='svg')
ggsave(file="Figures/gg_PAM_apo_sym.png", plot=gg_PAM_apo_sym)
```
