...
# Visualize ALL
PAM_day1_11_summary$day_NO3 <- factor(PAM_day1_11_summary$day_NO3, levels=c("Low_1","Low_11","Elevated_1","Elevated_11"))
gg_sym_state_PAM<-ggplot(data = PAM_day1_11_summary,
       aes(x = day_NO3,
           y = PAM_avg, col=temp, shape=sym_state, group=interaction(sym_state, temp))) +
    geom_point(size=4.5, position=position_dodge(width=0.2)) +
    geom_errorbar(aes(ymin=PAM_avg-se, ymax=PAM_avg+se), width=0.25, linewidth=0.8, position=position_dodge(width=0.2)) +
  #geom_line(data=PAM_day1_11_summary_BACKGROUND, aes(x=day, y=PAM_avg), linewidth=1, position=position_dodge(width=0.2), linetype="dotted")+
...
gg_sym_state_PAM
ggsave(file="Figures/gg_sym_state_PAM.svg", plot=gg_sym_state_PAM)
...
PAM_day1_11_summary <- full_join(sum_day1_temp_food, sum_day11_temp_food)
PAM_day1_11_summary$day <- as.factor(PAM_day1_11_summary$day)
PAM_day1_11_summary$day_NO3 <- paste(PAM_day1_11_summary$NO3_category, PAM_day1_11_summary$day, sep="_")
...
gg_food_PAM<-ggplot(data = PAM_day1_11_summary,
       aes(x = day_NO3,
           y = PAM_avg, col=temp, shape=food, group=interaction(food, temp))) +
    geom_point(size=4.5, position=position_dodge(width=0.2)) +
    geom_errorbar(aes(ymin=PAM_avg-se, ymax=PAM_avg+se), width=0.25, linewidth=0.8, position=position_dodge(width=0.2)) +
  #geom_line(data=PAM_day1_11_summary_BACKGROUND, aes(x=day, y=PAM_avg), linewidth=1, position=position_dodge(width=0.2), linetype="dotted")+
  geom_line(linewidth=1, position=position_dodge(width=0.2), linetype="dotted")+
...
theme(legend.position = "right",
 ...
 scale_x_discrete("Day", labels=c("1", "11", "1","11"))+
  ...
  theme(aspect.ratio = 1.2)
gg_food_PAM
ggsave(file="Figures/gg_food_PAM.svg", plot=gg_food_PAM)
