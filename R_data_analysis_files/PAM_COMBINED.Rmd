...
gg_sym_state_PAM <- ggplot(data = PAM_day1_11_summary,
  ...
  annotate("rect", xmin = highlight$xmin[1], xmax = highlight$xmax[1], ymin = -Inf, ymax = Inf, alpha = 0.2, fill = highlight$fill[1]) +
  annotate("rect", xmin = highlight$xmin[2], xmax = highlight$xmax[2], ymin = -Inf, ymax = Inf, alpha = 0.2, fill = highlight$fill[2]) +
