...
pam_all_nitrate.data <- read.csv("C:/Users/carol/OneDrive/Documents/PhD Boston University 2019-/Astrangia_nutrient_stressors_Rotjan_lab/Data/PAM_NITRATE_all_dead_deleted_all_controls_5.16.24.csv", header=TRUE, sep=",",stringsAsFactors = FALSE)
...
# all 20C FED
all_20_fed<-subset(pam_all_nitrate.data, pam_all_nitrate.data$temp=="20" & pam_all_nitrate.data$food=="F")
# all 30C FED
all_30_fed<-subset(pam_all_nitrate.data, pam_all_nitrate.data$temp=="30" & pam_all_nitrate.data$food=="F")
...
#DOSE DEPENDENCY -- symbiotic corals that experience the two highest doses (5, 18) experience significant decrease in PAM over 10 days
...
all_fed_model_vis$temp <- as.factor(all_fed_model_vis$temp)
# Visualize
gg_sym_state_temp_nitrate<-ggplot(data = all_fed_model_vis,
    ...
    ggtitle ("Nitrate PAM - % Change Fv/Fm") +
    labs(x = "Nitrate dose", 
