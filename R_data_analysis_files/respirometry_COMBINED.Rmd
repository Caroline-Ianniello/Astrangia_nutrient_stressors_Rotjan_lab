...
resp_all.data <- read.csv("/Users/carolineianniello/Astrangia Ecotox/Data/resp_combined_NO3categorized_outlier_removed_6_24_24.csv", header=TRUE, sep=",",stringsAsFactors = FALSE)
...
# Visualize
gg_all_treatments <-ggplot(data = sum_all_treatments,
    ...
    ylim(0.06, 0.16) +
  scale_x_discrete("Treatment", labels=c("Elevated No E. coli","Elevated + E. coli","Low No E. coli","Low + E. coli"))+
    labs(x = "Treatment", 
