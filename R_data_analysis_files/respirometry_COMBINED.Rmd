...
sum_all_treatments <- summarySE(resp_all.data, measurevar = "abs_resp_rate_SA_corr", groupvars = c("sym_state", "temp", "NO3_category_e_coli"))
# Visualize
gg_sym_state <-ggplot(data = sum_all_treatments,
       aes(x = NO3_category_e_coli,
           y = abs_resp_rate_SA_corr, col=temp, shape=sym_state)) +
    geom_point(size=4.5, position=position_dodge(width=0.8)) +
    geom_errorbar(aes(ymin=abs_resp_rate_SA_corr-se, ymax=abs_resp_rate_SA_corr+se), width=0.25, linewidth=0.8, position=position_dodge(width=0.8)) +
    ggtitle ("Respiration Rate By Treatment") +
    ...
    ylim(0.06, 0.16) +
  scale_x_discrete("Treatment", labels=c("Elevated NO3 No E. coli","Elevated NO3 + E. coli","Background NO3 No E. coli","Background NO3 + E. coli"))+
    labs(x = "Treatment", 
...
gg_sym_state
ggsave(file="Figures/gg_sym_state.svg", plot=gg_sym_state)

#Summarize all treatments by FOOD and temp
sum_all_treatments <- summarySE(resp_all.data, measurevar = "abs_resp_rate_SA_corr", groupvars = c("food", "temp", "NO3_category_e_coli"))
# Visualize
gg_fed_starved <-ggplot(data = sum_all_treatments,
       aes(x = NO3_category_e_coli,
...
gg_fed_starved
ggsave(file="Figures/gg_fed_starved.svg", plot=gg_fed_starved)
```
