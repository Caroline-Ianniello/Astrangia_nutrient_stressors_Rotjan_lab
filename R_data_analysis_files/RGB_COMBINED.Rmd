...
sum_food_temp_nitrate_RGB <- summarySE(RGB_all.data, measurevar = "red_delta", groupvars = c("food", "temp", "NO3_category"))
# Visualize
gg_sum_food_temp_nitrate_RGB <-ggplot(data = sum_food_temp_nitrate_RGB ,
       aes(x = NO3_category,
   ...
   ##scale_x_discrete("Nitrate Level", labels=c("0-6uM","6-10uM","10-20uM","10uM"))+
    labs(x = "Nitrate Dose", 
         ...
         caption = "data represent mean +/- SEM" ) +
       # theme(legend.position="none")+
  scale_shape_manual("Feeding status", labels=c("Fed","Starved"), values=c(18,8)) +
    scale_color_manual("Temperature", labels=c("20°C","30°C"), values=c("dodgerblue", "darkred"))

gg_sum_food_temp_nitrate_RGB 
```
