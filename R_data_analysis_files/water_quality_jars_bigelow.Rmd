...
#create a new column "NO3_category_temp_food"
...
gg_water_qual <- ggplot(water_qual_mean, aes(x=NO3_category, y=NO3_uM, shape= food, color=temp)) + 
  scale_color_manual(values=c("dodgerblue","darkred"), labels=c("20°C","30°C")) +
   scale_shape_manual("Feeding treatment", labels=c("Fed","Starved"), values=c(18,8)) +
  geom_point(size=4) +
    geom_errorbar(aes(ymin=NO3_uM-se, ymax=NO3_uM+se), width=0.25, linewidth=0.8) +
  ...
  ggtitle("Nitrate Levels in Jars")
gg_water_qual 
