...
all_HOBO_by_day<- read.csv("HOBO_all_by_day_4_7_23.csv", header=TRUE, sep=",",stringsAsFactors = FALSE)
all_HOBO_by_day <- na.omit(all_HOBO_by_day)
...
#Overall difference between chamber and temperate system temperature, averaged by day over all experiments
summary(aov(all_HOBO_by_day$temp ~ all_HOBO_by_day$chamber_or_temperate ))
