...
getwd()
# We made a separate Nitrate excel file and added RGB now so we're all set to upload & go
resp_all_nitrate.data <- read.csv("RESP_and_RGB_NITRATE_cleaned_dead_and_broken_outlierG28Y65_deleted_SA_CORR_12_18_2023.csv", header=TRUE, sep=",",stringsAsFactors = FALSE) #I added a new column called "control_or_nutrient" to make some plotting easier
