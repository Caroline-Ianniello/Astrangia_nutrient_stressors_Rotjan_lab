...
#All of the below formulas had the same AIC

clmm_PES_1 <- clmm(PES_value ~ PES_day + food + sym_state*temp +  (1|beetag_exprun) + (1|exp_num), data = pes_all.data)

AIC(clmm_PES_1, clmm_PES_1_rand)

clmm_PES_2 <- clmm(PES_value ~ PES_day + temp + food + sym_state*temp +  (1|beetag_exprun)+ (1|exp_num), data = pes_all.data)

clmm_PES_3 <- clmm(PES_value ~ PES_day + sym_state + food + sym_state*temp +  (1|beetag_exprun)+ (1|exp_num), data = pes_all.data)

clmm_PES_4 <- clmm(PES_value ~ PES_day + food + temp + sym_state*temp +  (1|beetag_exprun)+ (1|exp_num), data = pes_all.data)
