...
record_lambda(file = 'MSSP/doc/Analysis-Log/Cross-Validation-Results/PAM-Percent-Change-CV-Summary.md', 
              model_response = 'PAM_percent_change', 
              pollution_type = 'nitrate', 
              MSE_array = pam_percchange_MSE_arr)
