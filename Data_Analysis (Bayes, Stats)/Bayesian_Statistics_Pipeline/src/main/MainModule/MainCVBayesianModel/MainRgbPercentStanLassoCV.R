...
rgb_percchange_MSE_arr <- customizedRandomizedSearchCV(data = rgb_model, 
...
save(rgb_percchange_MSE_arr, file = 'MSSP/data/Cross-Validation-Results/MSE-Arrays/rgb_percchange_MSE_arr.RDS')
