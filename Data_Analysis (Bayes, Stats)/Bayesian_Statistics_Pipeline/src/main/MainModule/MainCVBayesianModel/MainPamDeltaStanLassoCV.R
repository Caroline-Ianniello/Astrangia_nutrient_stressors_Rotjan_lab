...
pam_model$temp <- as.character(pam_model$temp) # make it into a categorical variable
...
pam_delta_MSE_arr <- customizedRandomizedSearchCV(data = pam_model, 
...
save(pam_delta_MSE_arr, file = 'MSSP/data/Cross-Validation-Results/MSE-Arrays/pam_delta_MSE_arr.RDS')
