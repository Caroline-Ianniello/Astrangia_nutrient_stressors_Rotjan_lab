...
```{r upload data }
#upload data
water_qual_bigelow_all <- read.csv("/Users/carolineianniello/Astrangia_Ecotox/Data/experimental_jar_water_quality_all_6_21_24.csv", header=TRUE, sep=",",stringsAsFactors = FALSE)
...
water_qual_background <- water_qual_bigelow_all %>%
  filter(NO3_category=="Background")
range(water_qual_background$NO3_mean_observed)

water_qual_elevated <- water_qual_bigelow_all %>%
  filter(NO3_category=="Elevated")
range(water_qual_elevated$NO3_mean_observed)
