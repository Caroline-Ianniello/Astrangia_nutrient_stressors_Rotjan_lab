...
```{r input data}
env_chamber_HOBO <- read.csv("/Users/carolineianniello/Astrangia_Ecotox/Data/Environmental_Chamber_Summer2022_9_5_22.csv", header=TRUE, sep=",",stringsAsFactors = FALSE)
