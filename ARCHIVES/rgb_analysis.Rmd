...
getwd()
rgb_all.data <- read.csv("/Users/carolineianniello/Astrangia_Ecotox/Data/Master_RGB_Spreadsheet_Condensed_Red_1_12_23.csv", header=TRUE, sep=",",stringsAsFactors = FALSE)
library("dplyr")
library("plyr")
library("tidyverse")
library("Rmisc")
